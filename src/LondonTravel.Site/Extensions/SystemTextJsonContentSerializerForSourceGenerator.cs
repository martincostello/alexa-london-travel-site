...
/// </summary>
internal sealed class SystemTextJsonContentSerializerForSourceGenerator(JsonSerializerContext jsonSerializerContext) : IHttpContentSerializer
{
    public HttpContent ToHttpContent<T>(T item)
    {
        ...
        return new JsonContent(item, typeof(T), jsonSerializerContext);
    }
