...
/// <summary>
/// A class representing a document processor that adds security metadata. This class cannot be inherited.
/// </summary>
internal sealed class AddSecurityTransformer : IOpenApiDocumentTransformer
{
    /// <inheritdoc/>
