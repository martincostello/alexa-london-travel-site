...
/// <summary>
/// A class representing a document processor that adds API information. This class cannot be inherited.
/// </summary>
internal sealed class AddApiInfoTransformer(IOptions<SiteOptions> options) : IOpenApiDocumentTransformer
{
    /// <inheritdoc/>
