...
public class ResourceTests
{
    ...
    [InlineData("/assets/js/site.min.js", "text/javascript")]
    [InlineData("/assets/js/site.min.js.map", MediaTypeNames.Text.Plain)]
    [InlineData("/assets/js/site.manage.js", "text/javascript")]
    [InlineData("/assets/js/site.manage.js.map", MediaTypeNames.Text.Plain)]
    [InlineData("/assets/js/site.manage.min.js", "text/javascript")]
    [InlineData("/assets/js/site.manage.min.js.map", MediaTypeNames.Text.Plain)]
    [InlineData("/assets/js/site.preferences.js", "text/javascript")]
    [InlineData("/assets/js/site.preferences.js.map", MediaTypeNames.Text.Plain)]
    [InlineData("/assets/js/site.preferences.min.js", "text/javascript")]
